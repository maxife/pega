...
const { BaseMyCoHyaLibraryNbItemsAndLinkCard } = composeStories(DemoStories);

test('renders MyCoHyaLibraryNbItemsAndLinkCard', async () => {
  render(<BaseMyCoHyaLibraryNbItemsAndLinkCard />);
