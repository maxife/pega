...
import { MyCoHyaLibraryNbItemsAndLinkCard } from './index';
...
export default {
  ...
  component: MyCoHyaLibraryNbItemsAndLinkCard
};
...
type Story = StoryObj<typeof MyCoHyaLibraryNbItemsAndLinkCard>;
export const Default: Story = {
  render: args => {
    ...
    return <MyCoHyaLibraryNbItemsAndLinkCard {...props} />;
  },
  args: {
